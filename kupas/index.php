...
<html lang="en">
<head>
<title>Consultancy a Corporate Category Flat Bootstrap Responsive Website Template | Services :: w3layouts</title>
<!-- custom-theme -->
...
<!-- services -->
	<div class="services two">
		<div class="container">
			<h3 class="w3l_header w3_agileits_header">Produk <span>Olahan</span></h3>
			<div class="agile_inner_grids">	
				<div class="col-md-6 wthree_services_grid_left">
					<h3>Durian <span>Kupas</span> </h3>
					<h4> 100% daging durian Medan.</h4>
					<br>
					<div class="agileits_w3layouts_service_grid">
						
					<h4>Buah durian Medan pilihan</h4>
					</div>
					<h4>Buah durian Medan pilihan</h4>
					<label> </label><br> 
					<label>  Manis dan higienis</label> <br>
					<label> Sehat bebas pengawet</label> <br>
					<label> Daging Tebal</label><br> 
					<label> Buah matang sempurna</label> 
