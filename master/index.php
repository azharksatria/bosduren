      ...
      <ul class="sidebar-menu" data-widget="tree">
       ...
       <!--  <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="#berita" data-toggle="tab"><i class="fa fa-circle-o"></i>Berita</a></li>
            <li><a href="#slider" data-toggle="tab"><i class="fa fa-circle-o"></i>Slider</a></li>
            <li class="treeview">
              <a href="#coba" data-toggle="tab"><i class="fa fa-circle-o"></i> coba
                <span class="pull-right-container">
                  <i class="fa fa-angle-left pull-right"></i>
                </span>
              </a>
        ...
        <li><a href="#galery" data-toggle="tab"><i class="fa fa-book"></i> <span>Gallery</span></a></li>
